...
class _ExamListScreenState extends State<ExamListScreen> with SingleTickerProviderStateMixin {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(exam.subjectName.toUpperCase(), style: const TextStyle(fontSize: 10, color: Color(0xFFF97316), fontWeight: FontWeight.bold)),
  ...
  void _confirmDelete(BuildContext context, int id) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        title: const Row(children: [Icon(Icons.warning_amber_rounded, color: Colors.red), SizedBox(width: 8), Text('Delete Exam?')]),
