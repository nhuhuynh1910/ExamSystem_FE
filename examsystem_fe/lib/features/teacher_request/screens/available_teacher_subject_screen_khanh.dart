...
class _AvailableTeacherSubjectScreenKhanhState
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.send_outlined, color: primaryColor),
                            ),
                        ...
                        const Text('Reason for registration',
                            style: TextStyle(
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Explain why you want to teach this subject...',
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton.icon(
                            ...
                            icon: Icon(
                                ...
                                size: 19),
                            label: Text(selectedFileName ?? 'Choose certification file (optional)',
                                maxLines: 1, overflow: TextOverflow.ellipsis),
                            style: OutlinedButton.styleFrom(
                              foregroundColor: selectedFile == null ? textColor : Colors.green,
                              side: BorderSide(
                            ...
                            Expanded(
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () {
                                  ...
                                  if (reason.isEmpty) {
                                    setDialogState(() => reasonError = 'Reason is required.');
                                    return;
                                  }
                                  Navigator.pop(dialogContext);
                                  cubitContext.read<TeacherRequestCubitKhanh>().submitRequest(
                        ...
                        child: ListView(
                          ...
                          children: [
                            Row(
                              children: [
                                Container(
                                  ...
                                  child: const Icon(Icons.menu_book_outlined, color: primaryColor),
                                ),
                                const SizedBox(width: 12),
                                Expanded(
                                  child: Column(
                            ...
                            const _SubjectDetailTitleKhanh(
                                icon: Icons.info_outline_rounded, title: 'Subject information'),
                            const SizedBox(height: 10),
                            _SubjectDetailCardKhanh(
                              children: [
                                _SubjectDetailRowKhanh(
                                    label: 'Subject ID', value: subject.subjectId.toString()),
                                const Divider(height: 24),
                                _SubjectDetailRowKhanh(
                                    label: 'Subject name', value: subject.subjectName),
                                const Divider(height: 24),
                                _SubjectDetailRowKhanh(
                                    label: 'Description',
                                    value: subject.description?.trim().isNotEmpty == true
                                        ? subject.description!
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () {
                                  ...
                                  _showRequestDialog(cubitContext, subject);
                                },
                                icon: const Icon(Icons.send_rounded, size: 18),
                                label: const Text('Send Teaching Request',
  ...
  void _reload(BuildContext context) {
    context.read<TeacherRequestCubitKhanh>().loadAvailableSubjects();
  }
            ...
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  ...
                  icon: const Icon(Icons.history_rounded, color: textColor),
                ),
                IconButton(
                  tooltip: 'Refresh subjects',
                  onPressed: () => _reload(blocContext),
            ...
            body: SafeArea(
              child: BlocConsumer<TeacherRequestCubitKhanh, TeacherRequestStateKhanh>(
                listener: (context, state) {
                  if (state is TeacherRequestSuccessKhanh && state.message != null) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content: Text(state.message!), behavior: SnackBarBehavior.floating),
                    );
                  }
                  if (state is TeacherRequestErrorKhanh && state.error != null) {
                    ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget _buildBody(
    ...
    if (state.error != null && subjects.isEmpty) {
      return _ErrorStateKhanh(
          message: state.error!, onRetry: () => _reload(context));
    }
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _AvailableSubjectCardKhanh(
                  ...
                  onViewDetails: () => _showSubjectDetail(context, subject),
                );
              },
            );
          }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Available Teaching Subjects',
              style: TextStyle(color: textColor, fontSize: 22, fontWeight: FontWeight.w900)),
          const SizedBox(height: 4),
          const Text('Select a subject and submit your teaching request',
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                  ...
                  borderSide: const BorderSide(color: Color(0xfffdd7c9))),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(14),
        border: Border.all(color: const Color(0xfffddcd0)),
        boxShadow: const [
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            overflow: TextOverflow.ellipsis,
            style: const TextStyle(
                color: textColor, fontSize: 16, height: 1.25, fontWeight: FontWeight.w900),
          ),
          const SizedBox(height: 8),
          Text(
            ...
            maxLines: 3,
            overflow: TextOverflow.ellipsis,
            style: const TextStyle(color: Colors.blueGrey, fontSize: 12, height: 1.4),
          ),
          const SizedBox(height: 14),
          SizedBox(
            width: double.infinity,
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Text('Available',
              style:
                  TextStyle(color: Colors.green, fontSize: 10, fontWeight: FontWeight.w800)),
        ],
      ),
    );
  }
...
class _SubjectDetailTitleKhanh extends StatelessWidget {
  ...
  const _SubjectDetailTitleKhanh({required this.icon, required this.title});
...
class _SubjectDetailCardKhanh extends StatelessWidget {
  ...
  const _SubjectDetailCardKhanh({required this.children});
...
class _SubjectDetailRowKhanh extends StatelessWidget {
  ...
  const _SubjectDetailRowKhanh({required this.label, required this.value});
...
class _BadgeKhanh extends StatelessWidget {
  ...
  const _BadgeKhanh({required this.text, required this.color, required this.background});
        ...
        children: [
          Center(
            child: Container(
              ...
              child: Icon(isSearching ? Icons.search_off_rounded : Icons.menu_book_outlined,
                  color: primaryColor, size: 39),
            ),
          ),
          const SizedBox(height: 20),
          Text(isSearching ? 'No matching subjects' : 'No available subjects',
              textAlign: TextAlign.center,
              style: const TextStyle(color: textColor, fontSize: 19, fontWeight: FontWeight.w900)),
          const SizedBox(height: 8),
          Text(
            isSearching
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 14),
            const Text('Unable to load subjects',
