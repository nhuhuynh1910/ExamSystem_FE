...
@override
State<CreateQuestionScreenKhanh> createState() =>
_CreateQuestionScreenKhanhState();
}

class _CreateQuestionScreenKhanhState
extends State<CreateQuestionScreenKhanh> {
...
SubjectModelKhanh? _selectedSubject;
...
/* Remove an option and update the correct answer index. */
void _removeOption(int index) {
if (_isSaving || _optionControllers.length <= 2) {
return;
}
...
/* Check duplicate answer options. */
...
if (!didPop && _isSaving) {
_showMessage(
'Please wait while the question is being saved',
isError: true,
);
}
},
...
child: DropdownButtonHideUnderline(
child: DropdownButton<SubjectModelKhanh>(
...
return DropdownMenuItem<SubjectModelKhanh>(
value: subject,
child: Text(
subject.subjectName,
overflow: TextOverflow.ellipsis,
